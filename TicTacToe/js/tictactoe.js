...
let activePlayer ='X';
//This array stores an array of moves. We use this to determine win conditios.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condition checks whio's turn it is.
        if (activePlayer === 'X') {
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = 'O';
            //If active player is anythibng other than 'X'
        } else {
...
//This function perses the selectedSquares array to search for win conditions.
...
//This function untilize html canvas to draw win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This function interacts the canvas
    function animateLineDrawing() {
        //This variable creates the loop for when the game ends it restarts.
        const animationLoop = requestAnimationFrame(animateLineDrawing);
        //This method clearscontent from last loop iteration.
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2) { x += 10; }
            //This condition adds 10 to the previous end y poin.
            if (y < y2) { y += 10; }
...
//This function resets game in a tie or a win.
function resetGame() {
